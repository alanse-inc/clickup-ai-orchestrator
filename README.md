...
> **推奨**: Organization Secret に `ALANSE_CI_APP_ID` / `ALANSE_CI_APP_PRIVATE_KEY`（オーケストレーターと同じ GitHub App の値）を設定すると、Claude Code が作成した PR で CI が自動トリガーされます。詳細はセットアップガイドを参照してください。
